...
namespace UnitTests
{
    public class FirestoreDatabase : IDisposable
    {
        ...
        public void LoadAllData()
        {
            ...
            {
                new User { Name = "Eduardo", Email = "eduardo@gmail.com", IsAdmin = true, Points = 10, Release = DateTime.Now.AddYears(-1) },
                new User { Name = "Ricardo", Email = "ricardo@gmail.com", IsAdmin = false, Points = 20, Release = DateTime.Now.AddYears(-2) },
